      ...
      <Suspense fallback={
        <div className="flex items-center justify-center w-full h-full bg-gradient-to-br from-neutral-100 to-neutral-200 dark:from-neutral-800 dark:to-neutral-900 rounded-lg animate-pulse">
          <div className="text-center">
            <div className="w-8 h-8 mx-auto mb-2 border-2 border-neutral-400 border-t-transparent rounded-full animate-spin"></div>
            <p className="text-sm text-neutral-600 dark:text-neutral-400">Loading 3D Scene...</p>
          </div>
        </div>
      }>
        <Spline
